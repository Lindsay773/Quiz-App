...
function generateQuestion() {
  ...
  if (questionNumber < numQuestions) {
    ...
    return `
      ...
      <section class="questionForm" role="container">
        <form>
          <fieldset>
            <legend>
            <h1 class="quizQuestion">${quizItem.question}</h1>
            </legend>
...
function userAnswerFeedbackCorrect() {
  let correctAnswer = `${STORE.quizItems[questionNumber].correctAnswer}`;
  $('.questionPage').html(`
    <section class="answerFeedback" role="container">
...
function renderFinalFeedbackPage() {
  $('.questionPage').html(`
    <section class="finalFeedbackPage" role="container">
